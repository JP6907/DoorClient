...
public class FixFragment extends MyBaseFragment implements OnRefreshListener{
	...
	private void initListView() {
		...
		companyDatas = CompanyDataManager.createFitCompanyData();
	...
	public void onLoadingMore() {
		...
		new Handler(){
			...
			public void handleMessage(Message msg) {
				...
				newItems = CompanyDataManager.createFitCompanyData();
