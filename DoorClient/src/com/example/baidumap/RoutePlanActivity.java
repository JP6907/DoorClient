...
public class RoutePlanActivity extends Activity implements
	...
	private void initView() {
		...
		editSt.setText(myPlaceName);
		editEn.setText(goalPlaceName);
	...
	private void getIntentData() {
		...
		myCityName = intent.getStringExtra("myCityName");
		myPlaceName = intent.getStringExtra("myPlaceName");
		goalCityName = intent.getStringExtra("goalCityName");
		goalPlaceName = intent.getStringExtra("goalPlaceName");
	}
	...
	private void initMap() {
		...
		// 设置起终点信�?
		 stNode = PlanNode.withCityNameAndPlaceName(myCityName,myPlaceName );
		 enNode = PlanNode.withCityNameAndPlaceName(goalCityName,goalPlaceName);
	...
	public void SearchButtonProcess(View v) {
		...
		PlanNode stNode = PlanNode.withCityNameAndPlaceName(myCityName, editSt
				.getText().toString());
		PlanNode enNode = PlanNode.withCityNameAndPlaceName(goalCityName,
	...
	public void nodeClick(View v) {
		...
		popupText.setBackgroundResource(R.drawable.gray);
		popupText.setMaxEms(13);
		...
		mBaidumap.showInfoWindow(new InfoWindow(popupText, nodeLocation, -16));
